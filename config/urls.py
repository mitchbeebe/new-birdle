...
urlpatterns = [
    ...
    path("accounts/friends/request/", views.friend_request, name="friend_request"),
    path("accounts/friends/<int:pk>/accept/", views.friend_accept, name="friend_accept"),
    path("accounts/friends/<int:pk>/decline/", views.friend_decline, name="friend_decline"),
    path("accounts/friends/<int:pk>/remove/", views.friend_remove, name="friend_remove"),
    path("accounts/friends/invite/reset/", views.friend_invite_reset, name="friend_invite_reset"),
    path("accounts/friends/join/<str:token>/", views.friend_join, name="friend_join"),
